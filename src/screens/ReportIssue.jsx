...
export default function ReportIssue() {
  ...
  const handleSubmit = async () => {
    ...
    if (!title.trim())
      return setMessage({ type: "error", text: "Enter issue title." });

    if (!description.trim())
      return setMessage({ type: "error", text: "Enter description." });

    if (!categoryId)
      return setMessage({ type: "error", text: "Select a category." });

    if (!departmentId)
      return setMessage({ type: "error", text: "Select a department." });
